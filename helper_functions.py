...
############
    ...
    files_dir = '/Users/sidkoch/Documents/rutgers/sem2/cs598/project/'

    # select subjects
    all_subjects = range(63,301)
    subject_dir = files_dir + 'ltpFR/PEERS_older_adult_subject_list.txt'
    ...
    for s, subj in enumerate(subjects):
        ...
        for session in [1,2,3,4,5,6]: # excluding the first section which is a practice section
            ...
            if len(str(subj))<3:
                parent_dir = files_dir + 'ltpFR/LTP0' + str(subj) + '/session_' + str(session)
            else:
                parent_dir = files_dir + 'ltpFR/LTP' + str(subj) + '/session_' + str(session)
